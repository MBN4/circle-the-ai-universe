...
import { CheckCircle2, ArrowRight, Send, User, Mail, Phone, Tag, Info, Sparkles } from 'lucide-react';
    ...
    <div className="pt-32 pb-20 px-4">
            ...
            {[1, 2, 3].map((s) => (
              <div
                ...
                className={cn(
                  ...
                  s <= step ? "bg-dark-accent" : "bg-gray-800"
                )}
              />
            ))}
          </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3 rounded-xl glass dark:glass-dark text-white focus:outline-none focus:ring-2 focus:ring-dark-accent/50"
                      />
                    </div>
                  </div>
              ...
              {step === 2 && (
                ...
                >
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h3 className="font-bold text-white">Tool Details</h3>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl glass dark:glass-dark text-white focus:outline-none focus:ring-2 focus:ring-dark-accent/50"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          required
                          type="text"
                          placeholder="e.g. Design, Coding, Video"
              ...
              {step === 3 && (
                ...
                >
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h3 className="font-bold text-white">Final Details</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl glass dark:glass-dark text-white focus:outline-none focus:ring-2 focus:ring-dark-accent/50 resize-none"
                    />
                  </div>
      ...
      <Section className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">Submission FAQ</h2>
          <p className="text-gray-400">What to expect after you submit.</p>
        </div>
